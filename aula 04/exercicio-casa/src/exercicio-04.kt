fun main() {
    /*
     * 4. João Papo-de-Pescador, homem de bem, comprou um microcomputador para controlar o rendimento diário
    ...
    print("Quantos kgs de peixe? ")
    val pesoDePeixes = readLine()!!.toInt()

    val kilosMaximo = 50
    val valorPorKiloExcedente = 4.00

    val excesso = pesoDePeixes - kilosMaximo

    val multa = excesso * valorPorKiloExcedente
